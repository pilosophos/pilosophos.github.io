---
title: Creating character chemistry for RP
description: A character needs reasons for other characters to interact with them.
tags: [nonfiction, soapbox, writing]
published: 2026-03-27
---
# Creating character chemistry for RP

In a character-focused RP, the most important factor to consider when making a
...
around looking at their phones. There is no chemistry here.
...
If I'm a player who's deciding if I want my character to interact with yours,
...
Obviously, two characters with similar personalities will have more reasons to
...
then this is *great* chemistry because they'll always have reasons to talk to
each other. As long as the characters' suffering is fun for everyone to RP,
characters being enemies can be just as satisfying as being friends.

The most difficult personalities to play are shy characters and characters who
...
This is not to say that a shy character could *never* work. Shy characters could
*open up* when certain people talk to them, which encourages further interaction.
However, people still need that *initial reason* to approach a shy character.
This is where the character's background comes in.

## Chemistry through shared backgrounds

Shy or not, all characters benefit from having a full and **varied** background.
...
`"How is my character's life connected to other player characters' lives, whether directly or indirectly?"`

Crucially, the answers to this question are the reasons that other characters
should interact with yours, which is where we get our chemistry. The more "plot 
hooks" you add to their background, the more other players can find *some*
...
For instance, a programmer who works on bank software appears to have little to
...
at different schools, or they frequent the same sports bar and became friends that way.

Conversely, if your character's background consists of training in a secluded
...
personality if they want to fit into an RP.

## Summary
In a character RP, character chemistry is the engine that drives the entire
...
party who doesn't know anyone there.